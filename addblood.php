...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    </center> <h1 class="page-header"><mark>Add Doctors Details</mark></h1> </center>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            </center>  <h3> <mark>Please fill up the form below: </mark></h3> </center>
                                    ...
                                    <form role="form" action="addedblood.php" method="post">
                                       ...
                                       <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Specialist"  name="Specialist" required>
                                        </div>
                                        <br>
                                        ...
                                        <center>   <button type="submit" class="btn btn-success btn-default" style="border-radius: 0%;"><h1>Submit</h1></button></center>
                                                        <br><br>
